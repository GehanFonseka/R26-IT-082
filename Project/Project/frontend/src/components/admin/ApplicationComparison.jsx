...
function ApplicationComparison({ application }) {
  ...
  return (
    <details className="admin-application__comparison">
      ...
      <p className="admin-comparison__note">The percentage and classification above come from the server-side Hugging Face matching model. The fields shown here are the candidate CV snapshot and the job data used for that comparison.</p>
    </details>
  );
}
