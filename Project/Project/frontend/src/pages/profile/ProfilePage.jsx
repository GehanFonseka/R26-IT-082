...
const emptyProfile = { displayName: "", headline: "", location: "", skills: [], profilePhoto: "" };
...
function ProfilePage() {
  ...
  useEffect(() => {
    getMyProfile().then((response) => {
      if (response.data) {
        ...
        setCvCandidate(toMatcherCandidate(response.data.cv?.candidate));
  ...
  const uploadCv = async (event) => {
    ...
    try {
      ...
      const extractedCandidate = toMatcherCandidate(response.candidate || {});
