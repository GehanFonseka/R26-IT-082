...
import adminDashboardNetwork from "../../assets/admin-dashboard-network.png";
      ...
      <div className="cv-app-shell__main admin-app-shell__main">
        ...
        <main className={`admin-page admin-page--${mode}`} id="admin-overview">
          <div className="admin-page__container">
            ...
            <header className="admin-hero" style={{ "--admin-dashboard-network": `url(${adminDashboardNetwork})` }} aria-labelledby="admin-hero-title">
              <div className="admin-hero__content">
                <span className="admin-eyebrow"><i /> Admin command center</span>
                <h1 id="admin-hero-title">Build the team behind the next big idea.</h1>
                <p>Publish focused roles, keep every application in one place, and move great candidates forward with confidence.</p>
            ...
            <section className="admin-stats" aria-label="Recruiting overview">
              <article className="admin-stat"><span className="admin-stat__icon admin-stat__icon--purple"><Icon name="briefcase" size={17} /></span><div><small>Open jobs</small><strong>{openJobs}</strong><span>Currently accepting applications</span></div></article>
              <article className="admin-stat"><span className="admin-stat__icon admin-stat__icon--teal"><Icon name="people" size={17} /></span><div><small>Total applications</small><strong>{applications.length}</strong><span>Across every published role</span></div></article>
              <article className="admin-stat"><span className="admin-stat__icon admin-stat__icon--gold"><Icon name="spark" size={17} /></span><div><small>Needs review</small><strong>{newApplications}</strong><span>New candidate submissions</span></div></article>
              <article className="admin-stat"><span className="admin-stat__icon admin-stat__icon--blue"><Icon name="calendar" size={17} /></span><div><small>Interviews planned</small><strong>{scheduledInterviews}</strong><span>Upcoming conversations</span></div></article>
            </section>

            {mode === "overview" && <section className="admin-overview" aria-label="Hiring performance overview">
