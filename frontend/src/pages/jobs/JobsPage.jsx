...
function JobsPage() {
  ...
  const upcomingInterviews = useMemo(() => interviews
    ...
    .sort((first, second) => new Date(first.scheduledAt) - new Date(second.scheduledAt)), [interviews]);
