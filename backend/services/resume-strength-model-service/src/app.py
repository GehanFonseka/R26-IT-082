...
class PredictRequest(BaseModel):
    ...
    certifications: str = ""
    experienceEntries: list[str] = Field(default_factory=list, max_length=64)
    allProjects: list[str] = Field(default_factory=list, max_length=32)
    allSkills: list[str] = Field(default_factory=list, max_length=128)
