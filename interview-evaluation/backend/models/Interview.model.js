...
const interviewSchema = new mongoose.Schema(
  {
    ...
    answers: [{ questionId: String, answer: String, confidence: Number }],
    scores: {
    ...
    /** AI-assisted narrative + soft-skill dimensions (text-derived heuristics or external model). */
    aiAnalysis: {
      type: mongoose.Schema.Types.Mixed,
      default: null,
    },
    /** Authenticity, relevance, and validity checks per credential + aggregate trust. */
